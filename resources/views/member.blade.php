    ...
    <div class="container-fluid full-width-container">
        ...
        <div class="section section-custom billinfo" id="s"> 
            ...
            <div class="alert alert-success">
                {{ session('message') }} <i class="material-icons media-left pmd-sm">done_outline</i> 
            </div>
            @endif
            ...
            <div class="pmd-card pmd-z-depth">
                ...
                <div class="pmd-card-actions">
                    {{-- <a href="javascript:void(0);" class="btn btn-primary next" id="subform">บันทึก</a> --}}
                    {{-- <a href="javascript:void(0);" class="btn btn-default">ยกเลิก</a> --}}
